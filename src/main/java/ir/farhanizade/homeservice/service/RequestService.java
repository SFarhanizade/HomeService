...
public class RequestService {
    ...
    private Request convert2Request(UserCustomer owner, RequestInDto request) throws EntityNotFoundException {
    ...
    private RequestOutDto convert2Dto(Request request) {
        return RequestOutDto.builder()
                .service(request.getMyOrder().getService().getName())
                .createdDateTime(request.getCreatedTime())
                .status(request.getStatus())
                .orderStatus(request.getMyOrder().getStatus())
